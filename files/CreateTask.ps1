...
Register-ScheduledTask -Action $action -Trigger $trigger -TaskName "SQL_Install" -Description "SQL Installation processs" -User "$runAsUser\sqlservice" -Password "R3cruit3r"
